...
describe('AdministradorModel Unit Tests', () => {
  ...
  describe('create', () => {
    it('deve criar um administrador criptografando a senha', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(expect.stringContaining('INSERT INTO administrador'), [
        'Admin',
        'admin@teste.com',
        'hash123',
      ]);
  ...
  describe('update', () => {
    it('deve atualizar dados e senha', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(expect.stringContaining('UPDATE administrador SET'), [
        'Novo',
        'novo@email.com',
        'hashNew',
        1,
  ...
  describe('delete', () => {
    it('deve retornar o rowCount ao deletar', async () => {
      ...
      expect(db.query).toHaveBeenCalledWith(expect.stringContaining('DELETE FROM administrador'), [
        1,
      ]);
